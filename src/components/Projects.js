    ...
    <section>
      ...
      <div>
        ...
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/JEWELERY-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/JOURNAL-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/NETFLIX-CLONE-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/NEWS-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
      </div>
      <div>
        <h3>Mini Projects</h3>
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/CHATBOT-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/MCET-College-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/CARSNOW-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
        <div className="project">
          ...
          <a href="https://github.com/alanvz2212/STUDENT-MANAGEMENT-PROVIDER-GETX-Application" target="_blank" rel="noopener noreferrer">Source Code</a>
        </div>
      </div>
    </section>
  );
